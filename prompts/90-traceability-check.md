...
- Для каждого `REQ-SYS` есть критерий приемки/AC (`04_verification.md`).
- Для измененных интерфейсов (`03_interfaces.md`) указаны связанные `REQ-SYS` и стратегии совместимости/версионирования.
- НФТ (`02_quality.md`) имеют метрики и покрыты верификацией.
</checks>
